{
  ...
  //
  function onPlayerReady(event, pl_Id = "PL_-VfJajZj0U1MSx1IMu13oLJq2nM97ac") {
    if (pl_Id) {
      player.cuePlaylist({
        list: pl_Id,
        listType: "playlist",
  ...
  function onPlayerStateChange(event) {
    ...
    if (listIdVideo && vdState === 5 && !canRun) {
      canRun = true;
      preLoadBlock.setAttribute("style", "display: block !important;");
      ...
      var hidePreload = setTimeout(() => {
        preLoadBlock.setAttribute("style", "display: none !important;");
      }, 2000);
    }
